...
const HomePage = () => {
    ...
    return <>
        ...
        <Container>
            <input type="text" className=" mt-3" placeholder='search Product' id="exampleInputEmail1" aria-describedby="emailHelp" onChange={(e) => { setsearch(e.target.value) }} onKeyPress={(e) => e.key === 'Enter' ? data() : null} />
        </Container>
